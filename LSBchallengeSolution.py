...
#decode least significant bit to ascii
def decoded(toString):
    Finalbytes = int(toString, 2).to_bytes((len(toString) + 7) // 8, byteorder='big')
    text = Finalbytes.decode('ascii')
    return text

finalText = decoded(finalResult)
#print result
print(finalText)